...
- MathJax: when enabled, it will now render mathematical formulas also in the landing page citation box, search results and request's comments pages. See [Mathematical formulas (MathJax)](../../reference/settings.md#mathematical-formulas-mathjax) for configuration details.
