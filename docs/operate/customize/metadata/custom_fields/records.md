...
![Custom error message](../../imgs/custom_required_error.png)

**Custom validation function to validate the new field**

![Custom validation function](../../imgs/custom_validation_func.png)
...
![Custom fields in upload form](../../imgs/upload_form_custom_fields.png)
...
![Custom fields in additional details section](../../imgs/landing_page_fields_display.png)

The landing page with the configured custom fields:

![Custom fields in landing page](../../imgs/landing_page.png)
...
- `field_value`: the value of the field, as it is stored in the record after the UI serialization i.e. what is returned from the `ui_field` method when you [define your custom field](./custom_fields.md).
- `field_cfg`: the UI configuration for that specific field as it is defined in the `RDM_CUSTOM_FIELDS_UI` config.

See the example in the [How-to](./custom_fields.md).
...
![Custom field as search facet](../../imgs/search_facets.png)
...
You can see a detailed view of all the available widgets at the [UI widgets](./widgets.md) reference section.
