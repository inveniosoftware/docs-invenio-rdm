...
Branded Communities allow individual communities on the Invenio platform to have custom visual identities, styling, and some layout overrides — all while preserving the overall repository brand. This feature is particularly useful for communities who want their presence on InvenioRDM to reflect their brand identity.

This document describes how theming and branding can be applied to individual communities in InvenioRDM.

Each branded community can customize the styling and templating:
...
!!! info "Some other templates that you can override"
